    ...
    */
    while (Select_Game(fade)) {
        ...
        */
        ...
        if (TDMicro.Auto_Start_Skirmish() && TDMicro_Policy_Completed()) break;
...
bool Main_Loop()
{
    ...
    */
    ...
    if (PlayerWins) {
        ...
        TDMicro_Policy_Record_Outcome(TD_MICRO_POLICY_WIN);
    ...
    if (PlayerLoses) {
        ...
        TDMicro_Policy_Record_Outcome(TD_MICRO_POLICY_LOSS);
