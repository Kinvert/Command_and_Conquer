...
public:
    ...
    */
    ...
    int TDMicro_Stage_Timer(void) const
    {
        return Fetch_Stage_Timer();
    }
    int TDMicro_Rate(void) const
    {
        return Fetch_Rate();
    }
    int TDMicro_Balance(void) const
    {
        return Balance;
    }
    bool TDMicro_Is_Suspended(void) const
    {
        return IsSuspended;
    }
