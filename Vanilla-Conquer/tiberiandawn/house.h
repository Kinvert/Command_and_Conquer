...
public:
    ...
    */
    ...
    int TDMicro_Attack_Timer(void) const
    {
        return Attack;
    }
    int TDMicro_Building_Quantity(StructType type) const
    {
        return BQuantity[type];
    }
    int TDMicro_Infantry_Quantity(InfantryType type) const
    {
        return IQuantity[type];
    }
    int TDMicro_Unit_Quantity(UnitType type) const
    {
        return UQuantity[type];
    }
